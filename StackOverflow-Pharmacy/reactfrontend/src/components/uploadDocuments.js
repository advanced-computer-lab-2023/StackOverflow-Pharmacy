...
//  const userId="6555ac7d28f15aca03b5b303"
   fetch(`http://localhost:4000/api/pharmacists/uploadID?id=${userId}`, {
    method: 'POST',
    credentials: 'include',
    mode: 'no-cors',
    headers: {
...
const uploadPharmacyDegree = async (formData) => {
    ...
    console.log(userId)
  //  const userId="6555ac7d28f15aca03b5b303"
     fetch(`http://localhost:4000/api/pharmacists/uploadPharmacyDegree?id=${userId}`, {
      method: 'POST',
      credentials: 'include',
      mode: 'no-cors',
      headers: {
  ...
  const uploadWorkingLicences = async (formData) => {
    ...
    console.log(userId)
  //  const userId="6555ac7d28f15aca03b5b303"
     fetch(`http://localhost:4000/api/pharmacists/uploadWorkingLicences?id=${userId}`, {
      method: 'POST',
      credentials: 'include',
      mode: 'no-cors',
      headers: {
