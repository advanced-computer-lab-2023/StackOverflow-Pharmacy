...
router.post('/uploadID',upload.single('image'),pharmacistController.uploadID);
router.post('/uploadPharmacyDegree',upload.single('image'),pharmacistController.uploadPharmacyDegree);
router.post('/uploadWorkingLicences',upload.single('image'),pharmacistController.uploadWorkingLicences);
